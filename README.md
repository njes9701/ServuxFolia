...
- MiniHUD `servux:entity_data` v1 蜂巢 NBT，可顯示蜂巢內蜜蜂數量
...
1. 從 [Releases](https://github.com/njes9701/ServuxFolia/releases/latest) 下載 `ServuxFolia-1.0.0.jar`。
...
4. `/sfolia` 應顯示 `entityData=true (clients=1)`。
...
輸出位於 `build/libs/ServuxFolia-1.0.0.jar`。
...
Servux wire protocols used by Litematica, Tweakeroo and MiniHUD. Version 1.0.0
targets Folia 26.2 and Java 25. It provides Easy Place V3, bounded Litematica
NBT/Direct Paste support, MiniHUD structure overlays and beehive entity-data
sync. See the sections above for installation, permissions, safety defaults and
known limitations.
